...
class TMDB {
  Future<ISearch> searchAny(String query) async {
    var url =
        'https://api.themoviedb.org/3/search/multi?query=$query&include_adult=false&language=tr-TR&page=1';
    var headers = {
    ...
    return ISearch.fromJson(jsonData);
  }
